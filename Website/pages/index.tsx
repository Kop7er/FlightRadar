        ...
        <div className="flex h-screen">
            <div className="m-auto">
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <Link href="/livemap" className="flex flex-1 w-full lg:max-w-xs py-4 mr-8 bg-gray-900 text-white rounded-md place-content-center place-items-center">
                        <span className="mr-2">Live Map</span>
                        <MdRadar size={25} />
                    </Link>
                    <Link href="/liveflights" className="flex flex-1 w-full lg:max-w-xs mt-4 lg:mt-0 py-4 outline outline-2 outline-gray-900 text-gray-900 rounded-md place-content-center">
